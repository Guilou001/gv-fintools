...
Quatre observations mesurées le 30 août 2026 sur QQQ en juin 2026, avec un compte simulé gratuit. Les nombres de minutes et de volumes ci-dessous couvrent la journée entière, extensions comprises. En séance régulière, le contrôle du [dépôt 24](https://github.com/Guilou001/24-vwap-iex-vs-consolide) donne 99,7 % de présence IEX et un écart de volume entre fournisseurs de 0,66 %. Le périmètre horaire change donc fortement la lecture.
